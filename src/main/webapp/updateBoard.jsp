				...
				<form action="updateBoard.do" method="post">
					...
					<div class="row" style="margin-top: 30px">
						...
						<div style="padding-left: 300px">
							<br> <input class="form-control" name="writer" type="hidden"
								value="${board.writer }"> <label for="firstName"><h4
									class="mb-3">${board.writer }</h4></label>
						</div>

					</div>
					<div class="mb-3">
						<label for="Content">Content </label> <input style="height: 400px"
					...
					<div class="row">
						...
						<div class="col-md-2 mb-3">
							...
							<input name="regdate" type="hidden" value="${board.regDate }">
							<label for="Date">Date: ${board.regDate }</label>

						</div>
						<div class="col-md-2 mb-3">

							<input name="cnt" type="hidden" value="${board.cnt}"> <label
								for="Date">views: ${board.cnt }</label>
						</div>
